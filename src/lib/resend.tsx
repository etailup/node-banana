...
export async function sendEmail({
  ...
  subject,
  react,
  from = process.env.RESEND_FROM_EMAIL || "Node Banana <noreply@nodebanana.com>",
  replyTo,
}: SendEmailParams) {
...
const appUrl = process.env.NEXT_PUBLIC_APP_URL || "https://nodebanana.com"

export const emailTemplates = {
  welcome: (name: string) => ({
    subject: "Welcome to Node Banana!",
