      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="stat bg-base-200 rounded-box">
            ...
            <div className="stat-desc">Workflow runs</div>
          </div>
          <div className="stat bg-base-200 rounded-box">
            <div className="stat-title">Workflows</div>
            <div className="stat-value text-lg">0</div>
            <div className="stat-desc">Saved workflows</div>
          </div>
          <div className="stat bg-base-200 rounded-box">
            <div className="stat-title">API Keys</div>
            <div className="stat-value text-lg">0</div>
            <div className="stat-desc">
              <Link href="/dashboard/keys" className="link link-primary">
                Manage
              </Link>
            </div>
          </div>
          <div className="stat bg-base-200 rounded-box">
            ...
            <div className="stat-value text-success text-lg">Free</div>
            <div className="stat-desc">
        ...
        <div className="card bg-base-200">
          <div className="card-body">
            ...
            <div className="flex flex-wrap gap-3 mt-4">
              ...
              <Link href="/dashboard/keys" className="btn btn-outline btn-sm">
                Manage API Keys
              </Link>
              <Link href="/dashboard/jobs" className="btn btn-outline btn-sm">
                View Jobs
              </Link>
