...
export const metadata = {
  title: "Pricing - Node Banana",
  description: "Simple, usage-based pricing for AI workflow automation",
}
          ...
          <div className="container mx-auto max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="collapse collapse-arrow bg-base-100 rounded-xl">
                ...
                <div className="collapse-content text-base-content/70">
                  <p>Yes! The free plan gives you 50 workflow runs per month. Paid plans include a 14-day free trial.</p>
                </div>
              </div>
              <div className="collapse collapse-arrow bg-base-100 rounded-xl">
                <input type="radio" name="faq" />
                ...
                <div className="collapse-content text-base-content/70">
                  <p>We&apos;ll notify you when you&apos;re approaching your limits. You can upgrade anytime or your jobs will be queued until the next billing cycle.</p>
                </div>
              </div>
            </div>
          </div>
